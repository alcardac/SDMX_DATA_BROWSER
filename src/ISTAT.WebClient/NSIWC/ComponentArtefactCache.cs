...
// </copyright>
// -----------------------------------------------------------------------
namespace ISTAT.WebClient.NSIWC 
{
    using System;
        ...
        where T :  IItemSchemeObject<TI>
    {
        ...
        /// </returns>
        internal T GetArtefact(IComponent component)
        {
            T artefact;
        ...
        internal TI GetArtefactItemObject(IComponent component)
        {
            TI artefact;
        ...
        /// </exception>
        internal List<T> GetMergedItemScheme()
        {
        ...
        /// </param>
        internal void Update(IComponent component, T artefact)
        {
            this._componentMap.Remove(component);
        ...
        internal void UpdateItemObject(IComponent component, TI artefact)
        {
